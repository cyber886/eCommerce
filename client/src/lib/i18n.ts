...
const resources = {
  en: {
    translation: {
      ...
      "manageOrdersAndProducts": "Manage orders and control products",
  ...
  ru: {
    translation: {
      ...
      "manageOrdersAndProducts": "Управление заказами и товарами",
      "ordersManagement": "Управление заказами",
      "manageCustomerOrders": "Управление заказами клиентов",
  ...
  uz: {
    translation: {
      ...
      "manageOrdersAndProducts": "Buyurtmalar va mahsulotlarni boshqarish",
      "ordersManagement": "Buyurtmalar boshqaruvi",
      "manageCustomerOrders": "Mijoz buyurtmalarini boshqarish",
      "searchOrders": "Buyurtmalarni qidirish...",
      "filterOrders": "Buyurtmalarni filtrlash",
